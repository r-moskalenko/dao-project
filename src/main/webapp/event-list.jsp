    ...
    <div class="container-md">
      <div class="row">
        <div class="col-md-7 justify-content-end my-md-5">
          <a href="${pageContext.servletContext.contextPath}/api/events/create" type="button" class="btn btn-primary">
          New event
          </a>
        </div>
      </div>
    ...
    <c:forEach var="event" items="${listEvents}" varStatus="status">
      <div class="row featurette ">
        <div class="col-md-7 <c:if test="${status.index % 2 == 1}">order-md-2</c:if>">
          <h2 class="featurette-heading"><a href="reports?eventId=${event.id}">${event.shortDescription}</a> <span class="text-muted">It'll blow your mind.</span></h2>
