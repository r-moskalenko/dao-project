    ...
    <form method="post">
      <div class="row justify-content-center">
        <div class="col-4 order-1 py-4">
          <label for="reportTopic" class="form-label">Report text</label>
          <input type="text" id="reportTopic" class="form-control" name="reportTopic" />
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-4 py-2">
          ...
          <textarea id="reportText" class="form-control" name="reportText"  rows="3"></textarea>
        </div>
      </div>
